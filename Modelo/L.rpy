...
{ IProject 
	...
	- _myState = 8192;
	- _name = "L";
	- _objectCreation = "1127003145020152021526811";
	...
	- Diagrams = { IRPYRawContainer 
		...
		{ IDiagram 
			...
			- _name = "Model1";
			- _objectCreation = "1127005145020152021524811";
			- _umlDependencyID = "2161";
			- Annotations = { IRPYRawContainer 
				- size = 0;
			}
			- _lastID = 1;
			- _lastModifiedTime = "8.14.2015::23:50:8";
			- _graphicChart = { CGIClassChart 
				...
				{ CGIPackage 
					- _id = GUID 381ac6ac-0830-4e29-bc1b-ae5f3606e8e1;
					- _properties = { IPropertyContainer 
						- Subjects = { IRPYRawContainer 
							- size = 1;
							- value = 
					...
					- m_drawBehavior = 4104;
					- m_transform = 0.637335 0 0 0.558645 109 -2.9404 ;
				...
				{ CGIAnnotation 
					...
					- m_pParent = GUID 381ac6ac-0830-4e29-bc1b-ae5f3606e8e1;
					- m_name = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
						- m_color = { IColor 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.197107 0 0 0.140904 94.2174 182.74 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.173694 0 0 0.177038 385.982 175.333 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.162114 0 0 0.17212 649.579 194.929 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.180931 0 0 0.157367 877.089 206.023 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.185273 0 0 0.163924 103.556 504.733 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.19251 0 0 0.177038 379.706 504.568 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.160667 0 0 0.204905 644.872 504.424 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.172246 0 0 0.196708 888.072 502.653 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.165009 0 0 0.134417 150.627 914.508 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.20988 0 0 0.165563 426.777 887.585 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
				...
				{ CGIAnnotation 
					...
					- m_drawBehavior = 2056;
					- m_transform = 0.208841 0 0 0.173759 770.395 833.828 ;
					- m_bIsPreferencesInitialized = 1;
					- m_AdditionalLabel = { CGIText 
						- m_str = "";
						- m_style = "Arial" 10 0 0 0 1 ;
		...
		{ IDiagram 
			...
			- _myState = 10240;
			- _name = "objectmodeldiagram_0";
			- _objectCreation = "1127007145020152021522811";
			- _umlDependencyID = "3643";
			- _lastModifiedTime = "8.14.2015::23:26:26";
			- _graphicChart = { CGIClassChart 
